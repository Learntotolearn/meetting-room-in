      ...
      {rooms.map(room => (
        <Col xs={24} sm={12} md={8} key={room.id} style={{ display: 'flex', justifyContent: 'center' }}>
          <Card
            ...
            cover={<img alt="会议室" src={meetingRoomImage} style={{ height: 200, objectFit: 'cover', borderTopLeftRadius: 12, borderTopRightRadius: 12 }} />}
...
function RoomBookingPage({ rooms }) {
  ...
  return (
    <div style={{ maxWidth: 600, margin: '32px auto', background: '#fff', borderRadius: 12, boxShadow: '0 2px 8px rgba(0,0,0,0.06)', padding: 24 }}>
      <img src={meetingRoomImage} alt="会议室" style={{ width: '100%', height: 200, objectFit: 'cover', borderRadius: 12, marginBottom: 16 }} />
